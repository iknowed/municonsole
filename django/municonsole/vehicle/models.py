...
class Direction(models.Model):
    ...
    tag = models.CharField(max_length=24,db_index=True,blank=True)
    title = models.CharField(max_length=64,db_index=True,blank=True)
    name = models.CharField(max_length=24,db_index=True,blank=True)
...
#    direction = models.ForeignKey(Direction,blank=True)
#    seq = models.IntegerField(db_index=True,blank=True)
#    tag = models.CharField(max_length=16,db_index=True,blank=True)

class Speed(models.Model):
    route_tag = models.TextField(db_index=True,blank=True)
    dir_tag = models.TextField(db_index=True,blank=True)
    path = models.ForeignKey(Path,blank=True)
    hour = models.IntegerField(db_index=True,blank=True)
    datype = models.IntegerField(db_index=True,blank=True)
    speed = models.FloatField(db_index=True,blank=True)
